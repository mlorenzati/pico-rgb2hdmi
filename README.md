[![Build](https://github.com/charlysan/pico-rgb2hdmi/actions/workflows/build_and_publish.yml/badge.svg?branch=test-pipeline&job=build)](https://github.com/charlysan/pico-rgb2hdmi/actions/workflows/build_and_publish.yml)
# pico-rgb2hdmi
